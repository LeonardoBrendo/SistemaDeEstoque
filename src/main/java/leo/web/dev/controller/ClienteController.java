...
public class ClienteController {
	...
	public String salvar(
			@RequestParam String nomeCliente,@RequestParam String cpfCliente,
			@RequestParam Integer idadeCliente,@RequestParam String emailCliente,
			@RequestParam String senhaCliente,@RequestParam String telefoneCliente) {
